...
public class QRCode {
	...
	public static String readQRCode(String filePath, String charset, Map hintMap)
		...
		String phrase=qrCodeResult.getText();
		String delims = "[\n]+";
		...
		//return tokens2[1];
		String Blockletter=tokens2[1].substring(0,1);
		String Block;

		switch (Blockletter) {
        case "A":  Block = "Main block (A block)";
        		QRSound.main('A');
                 break;
        case "B":  Block = "science (B block)";
        		QRSound.main('B');
                 break;
        case "D":  Block = "Business (D block)";
        		QRSound.main('C');
        		break;
        case "E":  Block = "Engineering block";
        		QRSound.main('E');
        		break;
        case "F":  Block = "F block";
        		QRSound.main('F');
        		break;
        default: Block = "Invalid block letter";
                 break;
    }
		return Block;
